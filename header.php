					...
					<ul id="nav-solicitud">
						...
						<ul>
							<li><a href="solicitud.php?CodAm=<?php echo $solicitudes['CodAm']; ?>&&accion=1" class="icon-checkmark">&nbsp;Aceptar</a></li>
							 <?php /* <!-- icon-checkmark como ícono da la posibilidad de ACEPTAR a una solicitud de un usuario con accion=1 esta solicitud se envia a solicitud.php en donde se leen con if( isset($_GET['CodAm']) and isset($_GET['accion']))tambien &nbsp; para espacio en html--> */ 
							 ?>
				...
				<li id="info-notificaciones">
					...
					<?php if(!empty($not)): ?>
						<ul id="nav-notificaciones">
							...
							<?php /* Los valores de acción de la tabla notificaciones al ser de tipo bit, puede tener los valores 0 o 1 , TODO: los valores de CodNot son univocos pueden haber muchas CodNot por cada CodPost(de una publicacion) por ello al hacer click se debe enviar a post.php para actualizar las vistas y actualizar en la base de datos y en la interfaz de la pagina  */ ?>
							</li>
						</ul>
