<section>
	...
	<p class="speech-post" style="display:none;" id="<?php echo "speech_post".$clave; ?>"></p>
        ...
        <div class="publi-contene-like">
                <?php 
                /* 
                    mg::verificar_mg($posts['CodPost'], $_SESSION['CodUsua']) , funcion verificar en clase mg tiene el objetivo de comprobar si un usuario de la SESSION ya ha dado me gusta a una publicación por ello el condicional compara con ==0 
                */ 
                ?>
            <?php 
